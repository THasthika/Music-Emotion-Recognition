...
class A1D2DConvCat_V1(pl.LightningModule):
    ...
    def __build_model(self):
        ...
        self.feature_extractor = nn.Sequential(
            ...
            nn.Conv2d(in_channels=16, out_channels=32, kernel_size=7, stride=3),
            nn.BatchNorm2d(num_features=32),
            nn.ReLU(),
            
            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=7, stride=3),
            nn.BatchNorm2d(num_features=64),
            nn.ReLU(),

            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=7, stride=3),
        ...
        input_size = (self.config[self.ADAPTIVE_LAYER_UNITS_0] * self.config[self.ADAPTIVE_LAYER_UNITS_1] * 128)
