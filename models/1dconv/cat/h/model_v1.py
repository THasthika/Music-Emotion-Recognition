...
class H1DConvCat_V1(BaseCatModel):
    ...
    def __build_model(self):
        ...
        stft_nn_1 = nn.Sequential(
            ...
            nn.Conv2d(in_channels=1, out_channels=16, kernel_size=(13, 5), stride=(2, 1)),
            nn.ReLU(),
            
            nn.Conv2d(in_channels=16, out_channels=32, kernel_size=(13, 5), stride=(2, 1)),
            nn.MaxPool2d(kernel_size=(3, 3), stride=(2, 2)),
            nn.ReLU(),

            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(13, 5), stride=(1, 1)),
            nn.ReLU(),
            
            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(13, 5), stride=(1, 1)),
            nn.MaxPool2d(kernel_size=(3, 3), stride=(2, 2)),
            nn.ReLU(),
        ...
        stft_nn_2 = nn.Sequential(
            ...
            nn.Conv2d(in_channels=1, out_channels=16, kernel_size=(13, 5), stride=(3, 1)),
            nn.ReLU(),
            
            nn.Conv2d(in_channels=16, out_channels=32, kernel_size=(13, 5), stride=(3, 1)),
            nn.MaxPool2d(kernel_size=(3, 3), stride=(2, 2)),
            nn.ReLU(),

            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(13, 5), stride=(2, 1)),
            nn.ReLU(),
